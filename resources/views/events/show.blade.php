  ...
  <div class="col-md-10 offset-md-1">
    <div class="row">
      ...
      <div id="info-container" class="col-md-6">
        ...
        @else
        <p class="already-joined-msg">Você está participando do evento!</p>
        @endif
        <h3>O que vai ter no evento:</h3>
        <ul id="items-list">
          @if($event->items > 0)
          ...
          @endforeach
          @else
          <p>Não foi adicionado informações extras.</p>
          @endif
        </ul>
      </div>
      <div class="col-md-12" id="description-container">
        <h3>O que vai rolar no evento:</h3>
